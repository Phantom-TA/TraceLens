...
exports.THROTTLE_CONDITIONS = exports.DEVICE_PROFILES = void 0;
...
const DEFAULTS = {
    ...
    waitTimeout: 10_000,
    chromiumArgs: ["--no-sandbox", "--disable-setuid-sandbox", "--disable-dev-shm-usage", "--disable-gpu", "--disable-extensions"],
    screenshot: {
        fullPage: true,
        format: "png",
        quality: 90,
 ...
 */
function resolveDeviceProfile(mode, viewportOverride) {
    const base = exports.DEVICE_PROFILES[mode];
