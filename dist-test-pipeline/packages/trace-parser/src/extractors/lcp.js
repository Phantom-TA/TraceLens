...
exports.extractLCPFromTrace = extractLCPFromTrace;
exports.extractLCPFromLHR = extractLCPFromLHR;
 ...
 */
function extractLCPFromTrace(events, renderer, harEntries, renderBlockers) {
    ...
    const renderTime = (0, filters_js_1.tsToMs)(lastCandidate.ts, navigationStart);
 ...
 */
function extractLCPFromLHR(lhr) {
    if (!lhr.audits)
        return null;
    // LCP timing
