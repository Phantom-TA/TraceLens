...
exports.parseSourceMapExplorer = parseSourceMapExplorer;
const webpack_stats_js_1 = require("./webpack-stats.js");
/**
 * Parses source-map-explorer output into normalized bundle data.
 */
function parseSourceMapExplorer(input) {
...
function normalizeSMEBundle(bundle) {
    ...
    for (const [filePath, { size }] of Object.entries(bundle.files)) {
        ...
        const { packageName } = (0, webpack_stats_js_1.extractPackageInfo)(filePath);
        if (packageName) {
