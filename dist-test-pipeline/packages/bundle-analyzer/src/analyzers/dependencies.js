...
exports.extractLargestDependencies = extractLargestDependencies;
exports.computeInitialComposition = computeInitialComposition;
 ...
 */
function extractLargestDependencies(modules, totalBytes) {
 ...
 */
function computeInitialComposition(modules, initialSizeBytes, deps) {
