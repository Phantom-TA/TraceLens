...
export type BottleneckType = "heavy-javascript" | "render-blocking-resources" | "slow-server" | "hydration-delay" | "oversized-bundle" | "duplicate-packages" | "unoptimized-images" | "long-tasks" | "layout-instability" | "slow-lcp-resource" | "analytics-in-initial-bundle" | "missing-code-splitting";
