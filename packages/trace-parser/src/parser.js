...
function parseLHROnly(lhr, vitals, harEntries, url, parsedAt, dataQuality) {
    ...
    const longTasks = vitals.tbt !== null && vitals.tbt > 50
        ? [{ script: null, attributedScripts: [], attributionConfidence: 0.5, lcpOverlap: false, duration: vitals.tbt, startTime: vitals.fcp ?? 0, attribution: "scripting", breakdown: { scripting: vitals.tbt } }]
        : [];
    const bundleSignals = {
