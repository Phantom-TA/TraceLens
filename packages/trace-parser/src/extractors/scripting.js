 ...
 */
export function extractScriptingBottlenecks(events, renderer, longTaskScripts) {
 ...
 */
export function extractScriptingFromLHR(lhr) {
 ...
 */
export function extractRenderingTimeline(events, renderer) {
 ...
 */
export function computeBundleSignals(events, renderer, fcpMs, scriptingBottlenecks) {
    const { navigationStart } = renderer;
