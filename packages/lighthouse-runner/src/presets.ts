 ...
 */
export const BASE_CHROME_FLAGS: string[] = [
  "--headless=new",
  "--no-sandbox",
 ...
 */
export const DESKTOP_CONFIG: LighthouseConfig = {
 ...
 */
export const MOBILE_CONFIG: LighthouseConfig = {
  extends: "lighthouse:default",
  settings: {
    formFactor: "mobile",
    throttlingMethod: "simulate",
 ...
 */
export const CI_CONFIG: LighthouseConfig = {
  extends: "lighthouse:default",
  settings: {
    formFactor: "mobile",
...
export const PRESET_CONFIGS: Record<AuditPreset, LighthouseConfig> = {
