 ...
 */
export async function captureScreenshot(page, screenshotPath, config) {
 ...
 * @returns ScreenshotResult with path and success status
 */
export async function captureElementScreenshot(page, selector, screenshotPath, format = "png") {
    try {
